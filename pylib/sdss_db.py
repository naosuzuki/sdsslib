...
# Create 2D FITS File from DataFrame
   ...
   if((objtype=='star') or (objtype=='quasar')):
      ...
      col8=fits.Column(name='fibermagerr_g',format='E',array=psfmagerr_g_list)
      col9=fits.Column(name='fibermag_r',format='E',array=psfmag_r_list)
      col10=fits.Column(name='fibermagerr_r',format='E',array=psfmagerr_r_list)
      col11=fits.Column(name='fibermag_i',format='E',array=psfmag_i_list)
      col12=fits.Column(name='fibermagerr_i',format='E',array=psfmagerr_i_list)
      col13=fits.Column(name='fibermag_z',format='E',array=psfmag_z_list)
      col14=fits.Column(name='fibermagerr_z',format='E',array=psfmagerr_z_list)
